...
<div class="wrapper">
                            ...
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item" id="UserID3">
                                        ...
                                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/changepass" >Đổi mật khẩu</a>
                                </ul>
                            </div>
                            <!-- /.card-body -->
                        </div>
                                    ...
                                    <div class="" id="settings">
                                        <form class="form-horizontal" onsubmit="return false">
                                            <div class="form-group row">
                                                <input type="text" class="form-control input" id="ID1" placeholder="Name" disabled style="display: none">
                                                <label for="inputName" class="col-sm-2 col-form-label">Họ tên</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control input" id="Name1" placeholder="Name" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputEmail" class="col-sm-2 col-form-label">Ngày sinh</label>
                                                <div class="col-sm-10">
                                                    <input type="date" class="form-control" id="Day1" placeholder="Email" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputName2" class="col-sm-2 col-form-label">Địa chỉ</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="Address1" placeholder="Name" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputExperience" class="col-sm-2 col-form-label">Email</label>
                                                <div class="col-sm-10">
                                                    <input type="email" class="form-control" id="Email1" placeholder="Name" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputSkills" class="col-sm-2 col-form-label">Số điện thoại</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="Phone1" placeholder="Skills" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="offset-sm-2 col-sm-10">
                                                    <button  class="btn btn-danger" id="btn" onclick="Active1()">Sửa</button>
                                                    <button  class="btn btn-primary" id="btn1" onclick="Update1()" disabled>Xác nhận</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script src="operation/infoadmin.js"></script>
    <!-- Bootstrap 4 -->
