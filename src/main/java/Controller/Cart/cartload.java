...
public class cartload extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        {
            list.add(new ItemInCart(cart.get(i).getWatch_ID(),watch.get(i).getName(),watch.get(i).getPrice(),cart.get(i).getQuantity(),watch.get(i).getQuantityInStock(),watch.get(i).getSale()));
        }
        Gson gson=new Gson();
